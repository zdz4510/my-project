				...
				<div>
					<el-form :inline="true" :model="editForm" ref="editForm" :rules="rules" class="add-form" :label-width="formLabelWidth">
						<el-form-item label="不合格代码:" prop="ncCode">
							<el-input v-model="editForm.ncCode" disabled></el-input>
						</el-form-item>
								...
								<el-row>
									<el-col :span="24">
										<el-form-item label="描述:" prop="ncCodeDes">
											<el-input v-model="editForm.ncCodeDes" ></el-input>
										</el-form-item>
									</el-col>
								</el-row>
								<el-row>
							...
							<el-tab-pane label="不合格组" name="second">
								<el-row>
									<el-col :span="24">
										<el-row>
											<el-col :span="8">
												<el-table :data="allocated.filter(data => !ncGroup1 || data.ncGroup.toLowerCase().includes(ncGroup1.toLowerCase()))" @select="check1" @select-all="check1">
													<el-table-column label="已分配不合格组">
														<el-table-column label="">
															<template slot="header">
																<el-input v-model="ncGroup1" placeholder="输入不合格组搜索"/>
															</template>
											...
											<el-col :span="8">
												<el-table :data="undistributed.filter(data => !ncGroup2 || data.ncGroup.toLowerCase().includes(ncGroup2.toLowerCase()))" @select="check2" @select-all="check2">
													<el-table-column label="未分配不合格组">
														<el-table-column label="">
															<template slot="header">
																<el-input v-model="ncGroup2" placeholder="输入不合格组搜索"/>
															</template>
															<el-table-column type="selection" width="100"></el-table-column>
															<el-table-column prop="ncGroup" label="不合格组"></el-table-column>
															<el-table-column prop="ncGroupDes" label="不合格组描述"></el-table-column>
