      ...
      <div class="content" id="content">
        ...
        >
          ...
          <bar-code
            ...
            :height="item.height"
          />
          <d-text v-else-if="item.type == 3" :value="item.value"></d-text>
          <d-line
...
import { generateImagePreview } from "@/api/tag/tag.print.api.js";
export default {
  components: {
    Right,
    Top,
  ...
  methods: {
    ...
    save() {
      this.handleGenerateImagePreview();
    },
    savaData() {
    ...
    addComponentToCanvas(offsetX, offsetY, item) {
      ...
      const code =
        "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1578720021782&di=b4a4daef1a03ef6315141752ffe6345f&imgtype=0&src=http%3A%2F%2Fimg.mp.itc.cn%2Fq_mini%2Cc_zoom%2Cw_640%2Fupload%2F20161219%2Fa995d33bd30542529920537ac5df1afa_th.jpg";
      const brCode =
        "https://dss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=851763487,1733020085&fm=111&gp=0.jpg";
      if (item.type == 1) {
        url = code;
      } else if (item.type == 2) {
        url = brCode;
