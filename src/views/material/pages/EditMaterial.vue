...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        qtyRequired1: [{ validator: qtyRequired, trigger: "blur" }],
        qtyRequired2: [{ validator: qtyRequired, trigger: "blur" }],
        qtyRequired3: [{ validator: qtyRequired, trigger: "blur" }],
        length: [{ validator: numbertRequired, trigger: "blur" }],
        lengthErrorRange: [{ validator: numbertRequired, trigger: "blur" }],
        width: [{ validator: numbertRequired, trigger: "blur" }],
        widthErrorRange: [{ validator: numbertRequired, trigger: "blur" }],
        thickness: [{ validator: numbertRequired, trigger: "blur" }],
        thicknessErrorRange: [{ validator: numbertRequired, trigger: "blur" }],
        weight: [{ validator: numbertRequired, trigger: "blur" }],
        weightErrorRange: [{ validator: numbertRequired, trigger: "blur" }]
      },
      units: [
        {
          label: "CELL"
            ...
            if (res.code === 200) {
              ...
              if (this.cloneList.length == 1) {
                ...
                if (index > -1) {
                  ...
                  this.SETMATEDITLIST(
                    JSON.parse(JSON.stringify(this.matEditList))
                  );
                  this.cloneModify = JSON.parse(JSON.stringify(this.editForm));
                }
              }
