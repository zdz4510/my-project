        ...
        <div class="search-bar">
          ...
          >
            ...
            <el-form-item label prop>
              <el-button size="small" type="primary" @click="searchUndeal">查询</el-button>
              <el-button size="small" type="primary" @click="undealResetForm('undealSearchForm')">重置</el-button>
            </el-form-item>
          </el-form>
        </div>
        <div class="operate">
          <el-form :inline="true" class="demo-form-inline">
            <el-form-item>
              <el-button size="small" type="primary" @click="exportExcelUndeal">导出</el-button>
            </el-form-item>
            <el-form-item>
              <el-button
                size="small"
      ...
      <el-tab-pane label="已处理事件" name="second">
        <div class="search-bar">
          ...
          >
            ...
            <el-form-item label prop>
              <el-button size="small" type="primary" @click="searchDeal">查询</el-button>
              <el-button size="small" type="primary" @click="dealResetForm('dealSearchForm')">重置</el-button>
            </el-form-item>
          </el-form>
        </div>
        <div class="operate">
          <el-form :inline="true">
            <el-form-item>
              <el-button size="small" type="primary" @click="exportExcelDeal">导出</el-button>
            </el-form-item>
            <el-form-item>
              <el-button
                size="small"
