		...
		<div class="addForm">
          ...
          <el-col :span="8">
						<el-form-item label="数据收集组描述:" prop="dcGroupDes">
							<el-input class="dec" type="textarea" :autosize="{ minRows: 2, maxRows: 6}" v-model="addForm.dcGroupDes"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
...
<script>
	import {saveDataCollection, getAlarmList} from '../../../api/data.collection.api'
	export default {
